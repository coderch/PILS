...
public class NutzerDAO {
    ...
    public static Map<Nutzer, List<Vorhaben>> nutzerVorhabenUebersicht(List<Nutzer> nutzer, LocalDate start, LocalDate ende) {
        ...
        try (PreparedStatement pstm = DBConnect.preparedStatement("SELECT fk_t_soldat_pk_personalnummer,t_hat_vorhaben_im_zeitraum.fk_t_vorhaben_pk_t_name,t_hat_vorhaben_im_zeitraum.fk_t_zeitraum_pk_von, t_hat_vorhaben_im_zeitraum.fk_t_zeitraum_pk_bis,beschreibung FROM t_hat_vorhaben_im_zeitraum " +
